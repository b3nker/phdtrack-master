...
python3 lib_benjamin/use_case_random/decoupage_percentage_list_users.py dataset/users/ dataset/train_set/ dataset/test_set/ dataset/selected_random_users.csv "$ratio"
